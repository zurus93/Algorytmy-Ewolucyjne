...
Algorytm ewolucji ró¿nicowej operuje na populacji $\mu$ osobników: $P_1, P_2, \ldots, P_\mu$, gdzie $P_i \in \mathbf{R}^L$. Pocz¹tkowa populacja tworzona jest losowo. W ka¿dej iteracji $t$, dla ka¿dego osobnika $P_i$ z populacji liczony jest osobnik $P_j$ bêd¹cy œredni¹ wszystkich $\mu$ osobników populacji. Nastêpnie wybierane s¹ losowo osobniki $P_k$, $P_l$ takie, ¿e $i \neq l \neq k$. 
...
Nastêpnie dopasowanie osobnika próbnego $O_i$ porównywane jest z osobnikiem rodzica $P_i$ (funkcja $tournament$). Jeœli jest ono lepsze od rodzica, $P_i$ zostaje zast¹pione osobnikiem próbnym, w przeciwnym przypadku osobnik $O_i$ zostaje odrzucony.
...
Testy zostan¹ przeprowadzone przy pomocy 28 funkcji benchmarka CEC-2013. Zostan¹ nim poddane klasyczne algorytmy ewolucji ró¿nicowej oraz zmodyfikowana wersja uwzglêdniaj¹ca wybór œredniej populacji w mutacji. Ka¿dy test zostanie przeprowadzony 50 razy. Nastêpnie dla ka¿dego algorytmu, dla ka¿dej funkcji benchmarka zostanie obliczona œrednia wartoœæ testu.
